...
async function executeTest() {
    ...
    for (const b of config.escenarios) {
        ...
        const beforeImagePath = `pruebas-vrt/e2e/screenshots/backstop_default_${b.replace('.png', '')}png_0_document_0_desktop.png`;
        const afterImagePath = `pruebas-vrt/e2e/screenshots2/${b}`;
        ...
        fs.writeFileSync(`pruebas-vrt/results/compare-${b}.png`, data.getBuffer());
    }

    fs.writeFileSync(`pruebas-vrt/results/report.html`, createReport(datetime, resultInfo));
    fs.copyFileSync('index.css', `pruebas-vrt/results/index.css`);
