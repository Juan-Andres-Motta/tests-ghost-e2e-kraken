...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Post-button-1.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/final-review-1.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Publish-post-1.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/back-to-posts-1.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Post-button-2.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Deleted-Post-2.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Post-button-3.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/update-button-3.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/back-button-3.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Pages-button-7.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Publish-page-7.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Page-button-8.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Tags-button-4.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/slug-input-4.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Save-button-4.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/back-to-tags-4.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Tags-button-5.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Random-tag-5.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Slug-input-5.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Save-button-5.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Back-to-tags-5.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Tags-button-6.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Random-tag-6.png` });
  }
);
...
Then(
  ...
  async function (this: IPlaywrightWorld) {
    await this.page.screenshot({ path: `e2e/screenshots2/Delete-button-6.png` });
  }
);
...
Then("I click on page button 9", async function (this: IPlaywrightWorld) {
  ...
  Then("Take screenshot for visual regression page button 9", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Page-button-9.png` }); 
  });
  ...
  Then("Take screenshot for visual regression found page 9", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Found-page-9.png` }); 
  });
  ...
  Then("Take screenshot for visual regression title input 9", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Title-input-9.png` }); 
  });
  ...
  Then("Take screenshot for visual regression body input 9", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Body-input-9.png` }); 
  });
  ...
  Then("Take screenshot for visual regression update button 9", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Update-button-9.png` }); 
  });
  ...
  Then("Take screenshot for visual regression back button 9", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Back-button-9.png` }); 
  });
...
Then("I click on Dashboard button 10", async function (this: IPlaywrightWorld) {
  ...
  Then("Take screenshot for visual regression Dashboard button 10", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Dashboard-button-10.png` }); 
  });
  ...
  Then("Take screenshot for visual regression customize your design button 10", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Customize-your-design-button-10.png` }); 
  });
  ...
  Then("Take screenshot for visual regression accent color input 10", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Accent-color-input-10.png` }); 
  });
  ...
  Then("Take screenshot for visual regression Save button 10", async function (this: IPlaywrightWorld) {
	  await this.page.screenshot({ path: `e2e/screenshots2/Save-button-10.png` }); 
  });
