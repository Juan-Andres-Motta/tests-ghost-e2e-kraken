...
const LOG_FILENAME = "../../../results/smart-execution.html"
        ...
        if ($inputs.length > 0) {
            ...
            if (!Cypress.dom.isHidden(inp)) {
                ...
                if (inp.getAttribute("type") == "email") {
                    ...
                    cy.task("logCommand", { funtype: `email${type} ` })
...
function randomEvent() {
    ...
    if (pending_events[typeIndex] > 0) {
        ...
        cy.task("logCommand", { funtype: `function ${typeIndex} ${fIndex} ` })
